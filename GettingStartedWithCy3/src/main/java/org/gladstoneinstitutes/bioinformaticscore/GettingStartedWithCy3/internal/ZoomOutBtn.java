...
public class ZoomOutBtn extends JButton {
    public ZoomOutBtn() {
        super();

        final String iconUrl = (String) Services.zoomOutTFRef.getProperty(LARGE_ICON_URL);
        try {
        ...
        super.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (netView == null)
                    return;
                Services.taskMgr.execute(Services.zoomOutTF.createTaskIterator(netView));
            }
        });
    }
}
