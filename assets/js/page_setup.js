                ...
                '<li class="dropdown">' +
                    ...
                    '<ul class="dropdown-menu">' +
                        '<li class="dropdown-submenu">' +
                            ...
                            '</ul>' +
                        '</li>' +
                        '<li><a href="https://www.ncbi.nlm.nih.gov/pubmed/?term=GM103504" target="_blank">Publications</a></li>' +
                    '</ul>' +
                '</li>' +
                '<li class="dropdown">' +
...
var footerText =
    '<div class="belt black">' +
        '<div class="container">' +
                ...
                '</p>' +
                '<p>' +
                '&copy; NRNB, 2021 <i class="icon-envelope icon-white"></i> ' +
                '<a href="mailto:alex.pico@gladstone.ucsf.edu">email us</a>' +
                '</p>' +
        '</div>' +
    '</div>';
